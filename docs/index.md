...
<div class="profile-container">
    ...
    <div class="left-sidebar">
        ...
        <div class="avatar-wrapper">
            <img src="images/autumn.png" alt="Avatar" class="avatar-circle" onerror="this.src='https://ui-avatars.com/api/?name=4u&background=0D8ABC&color=fff'">
        </div>
        ...
        <div class="card status-box">
            <div class="box-header">
                ...
                <a href="status/" class="more-btn" title="查看更多">More+</a>
            </div>
...
.status-item { 
    ...
    display: flex;
    flex-direction: column; /* 让文字和日期垂直排列 */
    gap: 4px;
}
...
/* 贡献图 */
.graph-card { padding: 15px; overflow-x: auto; }
.contribution-grid {
    display: grid;
...
.grid-box { width: var(--box-size); height: var(--box-size); border-radius: 2px; }
/* 贡献图颜色 - 适配暗黑模式 */
...
/* 底部统计 */
.stats-footer { 
    display: flex; justify-content: center; gap: 20px; padding: 10px; margin-top: 20px; border: none; background: transparent; box-shadow: none;
}
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        statusData.slice(0, 4).forEach(item => {
            ...
            // 日期简化：只取 月-日，或者保留完整，这里保留完整但样式已优化
            div.innerHTML = `
